...
/// Provides an instance of [ApiServiceAuthentication] using Riverpod.
@riverpod
VendorAuthService vendorAuthService(Ref ref) {
  // Returns a new instance of ApiServiceAuthentication
